                ...
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                    <div className="p-8 pb-6 bg-gradient-to-b from-white to-gray-50">
                        <div className="text-center mb-6">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 text-secondary font-bold text-sm mb-3">
                                <Users className="h-4 w-4" />
                                Client Portal
                            </div>
                            <h2 className="text-2xl font-bold text-foreground">Client Login</h2>
                            <p className="text-muted-foreground text-sm mt-1">Access your shipping dashboard</p>
                        </div>
                    </div>
