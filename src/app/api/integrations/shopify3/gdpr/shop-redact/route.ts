...
export async function POST(request: Request) {
    try {
        ...
        console.log(`[GDPR App3] shop/redact for ${shop_domain}`);
        ...
        for (const userDoc of userSnap.docs) {
            ...
            console.log(`[GDPR App3] Redacted ${redactedCount} shipments for shop ${shop_domain} (user ${userId})`);
        }
        ...
        console.error('[GDPR App3] shop/redact error:', error);
        return NextResponse.json({ received: true });
    }
}
